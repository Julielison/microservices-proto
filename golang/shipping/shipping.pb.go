...
type CreateShippingRequest struct {
	...
	ShippingItems []*ShippingItem        `protobuf:"bytes,2,rep,name=shipping_items,json=shippingItems,proto3" json:"shipping_items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_shipping_proto_depIdxs = []int32{
	0, // 0: CreateShippingRequest.shipping_items:type_name -> ShippingItem
